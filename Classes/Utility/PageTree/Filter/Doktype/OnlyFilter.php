...
class OnlyFilter extends \Rattazonk\Extbasepages\Utility\PageTree\Filter\AbstractFilter {
	/**
	 * @return boolean
	 */
	protected function isResponsible() {		return isset($this->widgetConfiguration['onlyDoktype'])
