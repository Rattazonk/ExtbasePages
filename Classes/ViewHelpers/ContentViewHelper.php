...
use Rattazonk\Extbasepages\Domain\Model\Page;
...
class ContentViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
  ...
  /**
   * @param Rattazonk\Extbasepages\Domain\Model\Page $fromPage
   * @param int $fromColumn
   * @param string $as
   * @return string the rendered string
   **/
  public function render(Page $fromPage, $fromColumn, $as = 'content') {
    $this->templateVariableContainer->add(
      $as, $fromPage->getContentFromColumn( $fromColumn)
    );
