...
class PageTreeTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	protected function setUp() {
		$this->subject = new \Rattazonk\Extbasepages\Tree\PageTree();
	}
	 ...
	 * @test
	 */
	public function implementsRecursiveIterator() {
		$this->assertInstanceOf('\RecursiveIterator', $this->subject);
	}
	...
	public function iterable() {
		$mockOneOne = $this->getMock('\Object');
	}
}
