 ...
 */
class Under200FilterTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var Rattazonk\Extbasepages\Tree\Filter\Doktype\Under200Filter
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMockForAbstractClass(
			'Rattazonk\Extbasepages\Tree\Filter\Doktype\Under200Filter'
		);
	}
